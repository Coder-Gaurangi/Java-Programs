...
{                                                            //start of class
	...
	{                                                  //start of main method
		...
		num1=sc.nextInt();                            //1st number from user
		System.out.println("Enter second number: ");
		num2=sc.nextInt();                            //2nd number from user
		for(int i=1;i<=num1/2;i++)
		{                                
			if(num1%i==0)               //taking out factors of 1st number
			{
				sum1=sum1+i;               //adding factors of 1st number
			}
		}
		for(int i=1;i<=num2/2;i++)
		{                               
			if(num2%i==0)               //taking out factors of 2nd number
			{
				sum2=sum2+i;               //adding factors of 2nd number
			}
		}
